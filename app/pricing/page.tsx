...
const tiers = [
    {
        ...
        description: "Perfecto para pequeñas empresas o subcontratas que necesitan control básico.",
        features: [
    ...
    },
    {
        ...
        description: "Ideal para medianas empresas con operaciones continuas y trazabilidad rápida.",
        features: [
    ...
    },
    {
        ...
        description: "Para grandes operaciones, contratistas principales y consorcios.",
        features: [
                ...
                <div className="py-24 sm:py-32">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl text-center">
                            <h2 className="text-base font-semibold leading-7 text-primary">Precios Adaptables</h2>
                            <p className="mt-2 text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
                                Planes diseñados para operaciones de cualquier tamaño
                            </p>
                        </div>
                        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-muted-foreground">
                            Elige el plan ideal para automatizar los procesos de cumplimiento y no volver a tener paralizaciones.
                        </p>
                        ...
                        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
                            {tiers.map((tier) => (
                                <div
                                    key={tier.id}
                                    className={`rounded-3xl p-8 ring-1 xl:p-10 transition-shadow hover:shadow-lg bg-card ${tier.mostPopular ? 'ring-2 ring-primary relative' : 'ring-border'
                                        }`}
                                >
                                    {tier.mostPopular ? (
